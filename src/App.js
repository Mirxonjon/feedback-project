...
import SingleFeedback from "./pages/single-feedback/single-feedback";
...
const App = () => {
  ...
  const data = [
    ...
    {
      "id": 9,"title": "One-click portfolio generation",
      "category": "UI",
      "upvotes": 62,
      "status": "in-progress",
  ...
  const [filteredAlbums, setFilteredAlbums] = useState(feedbacks);
  const [category, setCategory] = useState(null);

  return (
    <FeedbacksContext.Provider value={{feedbacks, setFeedbacks, filteredAlbums, setFilteredAlbums, category, setCategory}}>
      <Routes>
